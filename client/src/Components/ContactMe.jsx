...
const ContactMe = () => {
  ...
  return (
    <>
      <div className="  text-white mt-10 flex-col pb-2 p-3">
        <div id="AboutMe" className="text-center mb-4">
          ...
          <div className="container border md:w-3xl border-zinc-500 rounded-2xl mx-auto  mt-3 ] font-medium ">
            <form class="max-w-3xl mx-auto    px-8 pt-8 rounded-2xl">
              <div class="mb-5">
                <input
                  type="email"
                  id="email"
            ...
            <div className="px-8 pb-6 w-full ">
              ...
              <button
                onClick={sendEmail}
                type="submit"
                class="text-gray-300 md:w-full border group border-zinc-500  hover:border-zinc-300 hover:text-white font-light rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center "
              >
                Send me an email
              </button>
            </div>
