    ...
    <>
      <div className="text-white  p-4 flex justify-center items-center  h-[100px] w-full bg-gradient-to-t from-transparent via-black to-black ">
        <div className="border  border-gray-500 w-fit bg-gradient-to-t from-black via-black to-transparent    mx-auto h-fit rounded-3xl  py-2 px-3 flex justify-center items-center gap-4">
          <div id="home-nav" className="hover:bg-zinc-500 rounded-full p-0.5 ">
            <a href="#Mainsection">
              <svg
          ...
          <div
            id="aboutme-nav"
            className="hover:bg-zinc-500 rounded-full p-0.5"
          >
            <a href="#AboutMe">
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          >
            <a
              href="https://www.linkedin.com/in/stalin-wesley/"
              target="_blank"
            >
          ...
          <div id="github-nav" className="hover:bg-zinc-500 rounded-full p-0.5">
            <a href="https://github.com/stalinw7r" target="_blank">
              <svg viewBox="0 0 128 128" fill="currentColor" className="size-6">
